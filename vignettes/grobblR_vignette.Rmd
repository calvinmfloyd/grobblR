...
The `grobblR` package provides R users with a way to quickly create dyanmic reports with attention to detail - a feature we did not believe to be readily accessible in other packages. In the future we hope to enhance and add even more features, but `grobblR`
